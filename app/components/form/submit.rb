class Components::Form::Submit < Components::Form::Base
  ...
  def view_template
    div class: "group relative inline-block focus:ring-3 focus:outline-hidden" do
      ...
      form.submit t(".#{action}"), class: "cursor-pointer relative inline-block border-1 border-current px-5 py-2 text-sm font-bold tracking-widest text-black uppercase"
    end
  end
